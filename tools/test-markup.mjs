...
// --- the system picker popover ---
{
  ...
  ok('picker is a popover: Dicebox pinned first, then systems alphabetical by label',
     ...
     order.join(',') === 'numeric,callofcthulhu,cthulhutech,dcc,deltagreen,daggerheart,fate,genesys,ironsworn,mist,mothership,pbta,starforged,starwars,onering,v5,cards,tarot,napoletane,hanafuda,utagaruta' &&
