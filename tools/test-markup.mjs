...
// --- the system picker popover ---
{
  ...
  ok('picker is a popover: Dicebox pinned first, then systems alphabetical by label',
     ...
     order.join(',') === 'numeric,callofcthulhu,cthulhutech,deltagreen,daggerheart,fate,genesys,mist,mothership,pbta,starwars,onering,v5,cards,tarot,napoletane,hanafuda,utagaruta' &&
